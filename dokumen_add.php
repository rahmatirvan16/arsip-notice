...
<head>
    ...
    <title>Tambah Dokumen - Arsip Digital</title>
...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-plus-circle"></i> Tambah Dokumen Baru</h2>
            <a href="dokumen.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali ke Dokumen</a>
        </div>

        <div class="card">
            <div class="card-header">
                <i class="fas fa-file-alt"></i> Form Tambah Dokumen
            </div>
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_dokumen" name="nama_dokumen" required placeholder="Masukkan nama dokumen">
                        </div>
                        <div class="col-md-6 mb-3">
